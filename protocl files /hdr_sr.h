...
struct sr_addr {
	...
	/*
	 * Metrics that I want to collect at each node Arun
	 */
	double	Pt_;
};
...
struct hdr_pkt {
	int type_of_packet;
//	nsaddr_t giving_authority_to_node;
	int giving_authority_to_node;
 	int parent_id;	// when ping arrived to receiver
 	int seq;
	int msg;
	int Pick_up_node_size ;
	nsaddr_t Pick_up_node; 		// sequence number
//nsaddr_t node_ID

	// Header access methods
	//static int offset_; // required by PacketHeaderManager
	//inline static int& offset() { return offset_; }
	//inline static hdr_pkt* access(const Packet* p) {
	//	return (hdr_pkt*) p->access(offset_);
	//}
};
...
//mine /arun
	struct hdr_pkt hdr_pkt_;
//..
public:


	//Values added by Arun
...
//Arun ...... calling a function header fields 
...
inline int& hdr_type_of_packet() {return hdr_pkt_.type_of_packet; }
inline int& hdr_Pick_up_node_size() {return hdr_pkt_.Pick_up_node_size; }
inline int& hdr_Pick_up_node() {return hdr_pkt_.Pick_up_node; }
inline int& hdr_giving_authority_to_node() {return hdr_pkt_.giving_authority_to_node; }
inline int& hdr_parent_id() {return hdr_pkt_.parent_id; }
inline int& hdr_seq() {return hdr_pkt_.seq; }
inline int& hdr_msg() {return hdr_pkt_.msg; }
